package fyi.hrvanovicm.magacin.presentation.javafx.factory;
...
public class CellValueFactory {
    ...
    public static <T> Callback<TableColumn.CellDataFeatures<ReportDTO, String>, ObservableValue<String>> reportType() {
    ...
    public static <T> Callback<TableColumn.CellDataFeatures<T, String>, ObservableValue<String>> reportType(
            Function<T, ReportDTO> reportExtractor
    ) {
        return cellData -> new SimpleStringProperty(reportExtractor.apply(cellData.getValue()).getType().toString());
    }

    public static <T> Callback<TableColumn.CellDataFeatures<ReportDTO, String>, ObservableValue<String>> reportCode() {
        return cellData -> new SimpleStringProperty(cellData.getValue().getCode());
    }
    ...
    public static Callback<TableColumn.CellDataFeatures<ReportDTO, String>, ObservableValue<String>> reportDate() {
    ...
    public static <T> Callback<TableColumn.CellDataFeatures<ReportDTO, String>, ObservableValue<String>> reportSignedByName() {
