-- Revert decimal precision from DECIMAL(15,6) back to DECIMAL(10,2)
-- WARNING: This will truncate values with more than 2 decimal places

-- 1. article_has_recipes.amount
...
-- 2. articles.in_stock_amount and in_stock_warning_amount
